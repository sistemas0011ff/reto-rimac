...
const handler = (event) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const appointmentService = iocContainer_1.default.get(iocContainer_1.TOKENS.CHILE_APPOINTMENT_SERVICE);
        ...
        for (const record of event.Records) {
            ...
            yield appointmentService.processMessage(messageBody);
        }
