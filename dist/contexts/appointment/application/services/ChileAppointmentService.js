...
exports.ChileAppointmentService = void 0;
/**
 ...
 */
class ChileAppointmentService {
    constructor(chileProcessor) {
        this.chileProcessor = chileProcessor;
    ...
    processMessage(messageBody) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.applyChileSpecificLogic(appointmentData);
                // Procesar la cita en el sistema de Chile (MySQL)
                yield this.chileProcessor.processAppointment(appointmentData);
                // Enviar confirmación a EventBridge
                const eventId = yield this.chileProcessor.sendConfirmation(appointmentData);
                // Actualizar métricas
                this.processedCount++;
     ...
     */
    validateChileAppointment(appointmentData) {
     ...
     */
    applyChileSpecificLogic(appointmentData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.validateChileBusinessHours(appointmentData);
                // Lógica específica 2: Aplicar reglas de seguros chilenos
                yield this.applyChileInsuranceRules(appointmentData);
                // Lógica específica 3: Verificar disponibilidad de especialistas en Chile
                yield this.checkChileSpecialistAvailability(appointmentData);
     ...
     * @param appointmentData Datos de la cita
     */
    validateChileBusinessHours(appointmentData) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param appointmentData Datos de la cita
     */
    applyChileInsuranceRules(appointmentData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (insuranceType) {
                case 'FONASA':
                    yield this.validateFONASARules(appointmentData);
                    break;
                case 'ISAPRE':
                    yield this.validateISAPRERules(appointmentData);
                    break;
                case 'Particular':
     ...
     */
    validateFONASARules(appointmentData) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    validateISAPRERules(appointmentData) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param appointmentData Datos de la cita
     */
    checkChileSpecialistAvailability(appointmentData) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.ChileAppointmentService = ChileAppointmentService;
